...
def display_lambda_max_sum(lambda_max_sum, root):
    lambda_max_sum_frame = tk.Frame(root)
    lambda_max_sum_frame.pack(side='top')
    lambda_max_sum_label = tk.Label(lambda_max_sum_frame, text='lambda_max_sum:')
    lambda_max_sum_label.grid(row=0, column=1)
    lambda_max_sum_value_label = tk.Label(lambda_max_sum_frame, text=f'{round( lambda_max_sum, 2):.2f}')
    lambda_max_sum_value_label.grid(row=0, column=2)
...
def display_coherence_index(coherence_index, root):
    coherence_index_frame = tk.Frame(root)
    coherence_index_frame.pack(side='top')
    coherence_index_label = tk.Label(coherence_index_frame, text='coherence_index:')
    coherence_index_label.grid(row=0, column=1)
    coherence_index_value_label = tk.Label(coherence_index_frame, text=f'{round( coherence_index, 2):.2f}')
    coherence_index_value_label.grid(row=0, column=2)
...
def display_coherence_index_percent(coherence_index, root):
    random_consistency_index_frame = tk.Frame(root)
    random_consistency_index_frame.pack(side='top')
    random_consistency_index_label = tk.Label(random_consistency_index_frame, text='random_consistency_percent:')
    random_consistency_index_label.grid(row=0, column=1)
    random_consistency_index_label = tk.Label(random_consistency_index_frame, text=f'{round(coherence_index, 2):.2f}' + ' %')
    random_consistency_index_label.grid(row=0, column=2)
