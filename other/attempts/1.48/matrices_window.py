...
def create_options_matrix(options_entries_list, options_entries):
...
def extract_and_create_change_options(options_size_entry, matrices_window):
    ...
    print(options_entries_list)
    options_btn = tk.Button(matrices_window, text='submit',
                            command=lambda: create_options_matrix(options_entries_list, options_entries))
